  ...
  try {
    ...
    if (serviceKey && supabaseUrl) {
      const statements = [
        ...
        // Multi-device push token registry (APNs via Expo Push)
        ...
        "CREATE INDEX IF NOT EXISTS idx_user_devices_user_active ON public.user_devices (user_id) WHERE is_active = TRUE;",
