...
configRouter.get("/", (c) => {
  return c.json({
    data: {
      ...
      supportUrl: "https://site.pathplus.store/support",
      marketingUrl: "https://site.pathplus.store",
      privacyUrl: "https://site.pathplus.store/privacy",
      termsUrl: "https://site.pathplus.store/terms",
      minAppVersion: "1.0.0",
